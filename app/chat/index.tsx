...
export default function ChatScreen() {
	...
	// Usar nuestro hook personalizado para interactuar con el modelo
	const { isReady, isLoading, isGenerating, loadModel, generateText, error } =
		useLlamaModel({ autoLoad: true });
